...
class Converter:
    ...
    def __init__(self):
        ...
        # Component which allows entry of characters. This is used for inputting the temperature.
        self.temp_entry = Entry(self.temp_frame,
                                font= ["Arial", "14"]
                                )
        self.temp_entry.grid(row=2, padx=10, pady=10)

        # Error message to respond to invalid inputs
       ...
       #button list (button text | bg colour | command | row | column)
        ...
        # Disable History button at first.
