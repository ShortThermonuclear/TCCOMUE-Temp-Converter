...
class Converter:
    ...
    def convert(self, min_temp, to_convert):
        """
        Converts temperature and updates answer label. Also stores
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        # setup dialogue box abd background colour
        background = "#ffe6cc"
        ...
        help_text = ("To use the program, simply enter the temperature "
                     ...
                     "temperature that is less that -273 degrees C, "
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        # Allows user to close the window using the cross at the top
